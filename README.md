...
| Lynis Audit | **84/100** sur une installation de référence, signe d’un durcissement déjà très avancé |
...
Sur une installation de référence, VPS-Secure atteint un Lynis hardening index de **84/100**, ce qui correspond à un niveau de durcissement très élevé pour un VPS public.
